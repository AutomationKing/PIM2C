...
{
	private String testLogPath, resultSummaryPath, resultSummaryPath_RMP;
	...
	public HtmlReport(ReportSettings reportSettings, ReportTheme reportTheme)
	{
		...
		resultSummaryPath_RMP = reportSettings.getReportPath() + Util.getFileSeparator() +
				"HTML Results" + Util.getFileSeparator() + "Summary_PIM2C" + ".html";
		...
		if (reportSettings.linkScreenshotsToTestLog) {
			testStepRow = 
					...
					"\t\t\t\t\t <td class='" + stepStatus.toString().toLowerCase() + "'>" +
							 		"<a href='.." + Util.getFileSeparator() + "Screenshots" + Util.getFileSeparator() + screenShotName + "'>" +
				 						stepStatus +
				 					"</a>" +
				 				"</td> \n";
		} else {
	...
	{
		resultSummaryPath = resultSummaryPath_RMP;
	...
	private void createResultSummaryHeaderTable(String strMarket)
	{
		BufferedWriter bufferedWriter;
		try {
	...
	public void addResultSummaryHeading(String heading, String strMarket)
	{
		if(!isResultSummaryHeaderTableCreated) {
			createResultSummaryHeaderTable(strMarket);
	...
	private void createResultSummaryMainTable(String strMarket)
	{
		BufferedWriter bufferedWriter;
		try {
	...
	public void addResultSummaryTableHeadings(String strMarket)
	{
		if(!isResultSummaryMainTableCreated) {
			createResultSummaryMainTable(strMarket);
	...
	@Override
	public void updateResultSummary(String scenarioName, String testcaseName, String testcaseDescription, String executionTime, String testStatus, double intCount)
	{
		try {
	...
	public void addResultSummaryFooter(String totalExecutionTime,
										int nTestsPassed, int nTestsFailed,String avgtime,String peaktime, String strMarket)
	{
		try {
										...
										"\t\t <table id='footer'> \n" +
											...
											"\t\t\t <tfoot> \n" +
												...
												"\t\t\t\t <tr class='subheading'> \n" + 
													...
													"\t\t\t </tr> \n" +
													"\t\t\t <tr class='subheading'> \n" + 
													"\t\t\t\t\t <td class='pass'>&nbsp;Avg.Execution</td> \n" + 
													"\t\t\t\t\t <td class='pass'>&nbsp;: " + avgtime + "</td> \n" +
													"\t\t\t\t\t <td class='pass'>&nbsp;Peak Execution</td> \n" + 
													"\t\t\t\t\t <td class='pass'>&nbsp;: " + peaktime + "</td> \n" +
												"\t\t\t\t </tr> \n" +
											"\t\t\t </tfoot> \n" +
										"\t\t </table> \n" +
									"\t </body> \n" +
