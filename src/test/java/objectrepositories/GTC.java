...
public class GTC
{
	...
	public static final String indx_EANUCC_code_PATH ="//span[contains(text(),'EAN UCC')]";
	...
	public static final String indx_eFunction_Name_PATH ="//span[contains(text(),'eFunctionalName')]";
