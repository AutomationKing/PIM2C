...
public class locator {
	...
	public static final String ECOM_TAB_reatiler_attribute="//td[3]/div/input";//".//*[@id='article_ECommerceView_tab']/div/div/div/div[1]/div/table/tbody/tr[1]/td[3]/div/div";
	...
	public static final String first_element="//div[2]/div/table/tbody/tr/td[5]/div ";
	...
	//public static final String Brand_Name_Attribute_available="//tr[.//td[.//div[contains text(),'Allergen Statement Attribute available']]]";
	/*public static final String uk_dq_features_benefits="//tr[.//td[.//div[contains text(),'Features and Benefits Attribute available']]]";
	public static final String uk_dq_health_claim="//tr[.//td[.//div[contains text(),'Health Claims Attribute available']]]";
	public static final String uk_dq_longform_loc="//tr[.//td[.//div[contains text(),'Longform Product Description']]]";//"//tr[contains(@class,'v-table-row-odd')]/td[contains(@class,'v-table-cell-content')]/div[contains(@class,'v-table-cell-wrapper')and text()='Longform Product Description']";
				*/
	//Longform Product Description;
	//public static final String longform_status="";
    ...
    public static final String is_ecom_validation_cn="//div[contains(text(),'New Product Validation For China – Is eCommerce product ')]";
    public static final String ecom_enrichment_task_cn="//div[contains(text(),'New Product Development - eCommerce Enrichment ')]";
    public static final String BB_tab_us_bb_task_cn="//div[contains(text(),'New Product Development - Brand Building Enrichment - Clear')]";//Brand Building View
}
